...
SensorsData inferLowestValues() {
    ...
    for(SensorsData data : sensorsDataHolder) {
        ...
        sensorsData.chargeRate = getLowestValue(sensorsData.chargeRate,  data.chargeRate);
    }
    return sensorsData;
}
...
SensorsData inferHighestValues() {
    ...
    for(SensorsData data : sensorsDataHolder) {
        ...
        sensorsData.chargeRate = getHighestValue(sensorsData.chargeRate,  data.chargeRate);
    }
    return sensorsData;
}
